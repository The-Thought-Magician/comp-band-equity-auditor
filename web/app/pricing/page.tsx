    ...
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <section className="mx-auto max-w-5xl px-6 py-20 text-center">
        ...
        <div className="mx-auto mt-12 grid max-w-3xl gap-6 md:grid-cols-2">
          {/* Free */}
          <div className="flex flex-col rounded-2xl border border-violet-500/40 bg-slate-900/60 p-8 text-left">
            <div className="flex items-center justify-between">
              <h2 className="text-lg font-semibold text-violet-300">Free</h2>
            ...
            <p className="mt-2 text-sm text-slate-400">All features, all yours.</p>
            ...
            <Link
              href="/auth/sign-up"
              className="mt-8 rounded-lg bg-violet-600 px-4 py-3 text-center font-semibold text-white hover:bg-violet-500"
            >
              Start free
            </Link>
          </div>
          ...
          {/* Pro */}
          <div className="flex flex-col rounded-2xl border border-slate-800 bg-slate-900/40 p-8 text-left">
            <h2 className="text-lg font-semibold text-slate-200">Pro</h2>
            ...
            <button
              ...
              className="mt-8 cursor-not-allowed rounded-lg border border-slate-700 px-4 py-3 text-center font-semibold text-slate-400 opacity-60"
            >
              {stripeEnabled === null
